...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7271)), "R:\\fish-farm\\fish-farm-web\\app\\(auth)\\profile\\page.jsx"],
    ...
    const pages = ["R:\\fish-farm\\fish-farm-web\\app\\(auth)\\profile\\page.jsx"];

    

    const originalPathname = "/(auth)/profile/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/(auth)/profile/page","pathname":"/profile","bundlePath":"app/(auth)/profile/page","filename":"","appPaths":[]}}
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 548))
...
/* harmony import */ var react_lazy_load_image_component_src_effects_blur_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2476);
...
const Profile = ()=>{
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        ...
        setData(data);
        axios__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z.get(`http://api.isda.farm/getuni/${data?.userId}`).then((res)=>{
            setTrans(res.data);
        }).catch((err)=>{
            console.log(err);
        });
                            ...
                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("img", {
                                        ...
                                        alt: "refer",
                                        className: "w-[150px] mx-auto h-[150px] rounded-full"
                                    }),
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                        className: "profile_wrap flex justify-center w-full mt-4 flex-col items-center",
                                        children: [
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                        ...
                                        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("button", {
                                            onClick: logout,
                                            className: "w-full rounded-2xl flex justify-center items-center mt-5 text-white py-3 bg-transparent border-[1px] outline-none  px-2 text-md font-black",
                                            children: [
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`R:\fish-farm\fish-farm-web\app\(auth)\profile\page.jsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [669,716,813,844], () => (__webpack_exec__(9585)));
