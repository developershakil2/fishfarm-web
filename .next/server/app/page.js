...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4476)), "R:\\fish-farm\\fish-farm-web\\app\\page.js"],
          metadata: {
    ...
    const pages = ["R:\\fish-farm\\fish-farm-web\\app\\page.js"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4735))
...
const proxy = (0,module_proxy.createProxy)(String.raw`R:\fish-farm\fish-farm-web\app\(components)\Nav.js`)
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx("h1", {
                        className: "text-white text-4xl px-2  text-center font-black",
                        children: "Fish Farm Investment World"
                    }),
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        className: "w-[680px] hero_p  flex justify-center items-center flex-col mx-auto",
                        children: [
                            /*#__PURE__*/ jsx_runtime_.jsx("p", {
                                className: "text-center mt-4  text-white",
                                children: "Dive into Success with Fish Farm Investment World - The Future of Aquaculture. Unlock Profitable Opportunities in Aquaculture with Fish Farm Investment World. Make Waves in the Aquaculture Industry - Invest in Fish Farm Investment World Today."
                            }),
                            /*#__PURE__*/ jsx_runtime_.jsx("a", {
                                href: "/login",
                                className: "py-4 px-8 backdrop-blur-2xl rounded-xl mt-5 bg-[#00e5ff17] font-black text-white",
...
var __webpack_exports__ = __webpack_require__.X(0, [669,716,632,844], () => (__webpack_exec__(9747)));
