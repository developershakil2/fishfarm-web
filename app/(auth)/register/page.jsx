      ...
      </div>
    {
        ...
        <div className="w-[350px]   bg-[#0098ff75] rounded-xl">
            ...
            <div className="flex flex-col justify-center px-5 my-2 items-start">
                ...
                <input type="text" value={actualRefLink? actualRefLink : ''} onChange={(e)=> setReferral(e.target.value)} className="w-full text-white rounded-2xl py-3 bg-transparent border-[1px] outline-none  px-2 text-sm font-black" placeholder="refer code optional !" />
            </div>
